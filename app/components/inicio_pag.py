...
# Constantes para las clases CSS reutilizables
...
TITLE_CLASSES = "text-5xl md:text-7xl font-bold text-white tracking-tighter text-shadow-lg"
...
def RntireButtons() -> rx.Component:
    return rx.el.div(
        ...
        rx.el.button(
            ...
            class_name=BUTTON_SECONDARY,
        ),
        class_name="mt-10 flex flex-col sm:flex-row gap-4",
    )

# Componente para el ícono principal animado
...
# Componente para el contenedor del ícono principal
...
def StatusBox() -> rx.Component:
    return rx.el.div(
        rx.el.p(
            "Estado: Operativo",
            class_name="text-xs text-teal-300 font-semibold",
        ),
...
# Componente para las barras verticales
...
# Componente para los íconos de usuarios y laptop
...
# Componente para la sección animada
...
# Componente principal del Hero Section
