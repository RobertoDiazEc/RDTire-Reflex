...
ADMIN_NAV = [
    ...
    {"name": "Ventas", "path": "/sales", "icon": "shopping-cart"},
    {"name": "Usuarios", "path": "/customers", "icon": "users"},
    {"name": "Vehiculo", "path": "/vehicles", "icon": "car"},
    {"name": "Inspección", "path": "/inspections", "icon": "search"},
    {"name": "Analisis", "path": "/analytics", "icon": "bar-chart-3"},
    {"name": "Reportes", "path": "/reports", "icon": "file-text"},
    {"name": "Ajustes", "path": "/settings", "icon": "settings"},
]
USER_ADMIN_NAV = [
    {"name": "Dashboard", "path": "/redxtire", "icon": "layout-dashboard"},
    {"name": "Usuario", "path": "/customers", "icon": "users"},
    {"name": "Vehiculo", "path": "/vehicles", "icon": "car"},
    {"name": "Inspección", "path": "/inspections", "icon": "search"},
    {"name": "Reportes", "path": "/reports", "icon": "file-text"},
]
